/**
 * @hide
 * The base directive class.  Classes extending [include.Doc.Pair] [include.Doc.Pair.static.add|add] directives
 * to be matched against.  The available directives are:
 * <ul>
 *     <li>[include.Doc.Directive.Init|init]</li>
 *     <li>[include.Doc.Directive.Param|param]</li>
 *     <li>[include.Doc.Directive.Inherits|inherits]</li>
 *     <li>[include.Doc.Directive.Return|return]</li>
 *     <li>[include.Doc.Directive.Author|author]</li>
 *     <li>[include.Doc.Directive.Hide|hide]</li>
 *     <li>[include.Doc.Directive.CodeStart|codestart]</li>
 *     <li>[include.Doc.Directive.CodeEnd|codeend]</li>
 *     <li>[include.Doc.Directive.Alias|alias]</li>
 *     <li>[include.Doc.Directive.Plugin|plugin]</li>
 * </ul>
 * <h3>How directives work</h3>
 * Directives mix in their add and add_more functions into include.Doc.Pair classes.  
 * These functions work with [include.Doc.Pair.prototype.comment_setup|Pair::comment_setup] to
 * read directives (things that look like <i>@something</i>) and make sense of their data.
 * 
 * 
 */
jQuery.Class.extend("include.Doc.Directive",
/* @prototype */
{
    /**
     * Called when [include.Doc.Pair.prototype.comment_setup|comment_setup] first sees a line with the matching
     * directive.
 ...
 */
include.Doc.Directive.extend('include.Doc.Directive.Init',
{
    add: function(line){
 ...
 */
include.Doc.Directive.extend('include.Doc.Directive.Param',{
 ...
 */
include.Doc.Directive.extend('include.Doc.Directive.Inherits',{
    add: function(line){
 ...
 * Matches multiple lines.
 */
include.Doc.Directive.extend('include.Doc.Directive.Return',{
    add: function(line){
 ...
 */
include.Doc.Directive.extend('include.Doc.Directive.Author',{
    add: function(line){
 ...
 */
include.Doc.Directive.extend('include.Doc.Directive.Hide',{
    add: function(line){
 ...
 */
include.Doc.Directive.extend('include.Doc.Directive.CodeStart',{
    add: function(line){
 ...
 * Stops a code block
 */
include.Doc.Directive.extend('include.Doc.Directive.CodeEnd',{
    add: function(line){
 ...
 * 
 */
include.Doc.Directive.extend('include.Doc.Directive.Alias',{
    add: function(line){
 ...
 */
include.Doc.Directive.extend('include.Doc.Directive.Plugin',{
    add: function(line){
 ...
 */
include.Doc.Directive.extend('include.Doc.Directive.Tag',{
    add: function(line){
